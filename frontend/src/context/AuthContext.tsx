...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const login = async (data: LoginRequest) => {
    try {
      ...
      if ('data' in response && (response.data as LoginOTPPendingResponse).otp_required) {
      ...
      switch (authResponse.data.user.role) {
        ...
        case 'GA':         navigate('/ga/dashboard');    break;
        case 'room_admin': navigate('/admin/dashboard'); break;
        default:           navigate('/');
      }
    } catch (error: any) {
