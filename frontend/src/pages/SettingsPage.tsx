...
import {
  ...
  Moon, Sun, Monitor, Edit2, Camera, ShieldCheck, Settings2, Building2,
} from 'lucide-react';
...
export const SettingsPage = () => {
  ...
  // true when the current user's password is managed by Active Directory
  const isLDAPUser = user?.auth_type === 'ldap';
                ...
                <div className="space-y-1.5 min-w-0">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {isLDAPUser ? (
                      ...
                      <Badge variant="outline" className="text-xs">Local Account</Badge>
                    )}
                  </div>
        ...
        <TabsContent value="security">
          <div className="space-y-6">
            ...
            {/* ── Change Password Card ─────────────────────────────
                Hidden for LDAP users — their password is managed in Active Directory.
                Shown only for local accounts (e.g. the seeded admin).
            ─────────────────────────────────────────────────────── */}
            {isLDAPUser ? (
              // Info box for AD users
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-2">
                    <Building2 className="h-5 w-5 text-muted-foreground" />
                    <CardTitle className="text-muted-foreground">Change Password</CardTitle>
                  </div>
                  <CardDescription>Password dikelola oleh Active Directory</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="rounded-lg bg-muted/50 border border-dashed p-4 space-y-1">
                    <p className="text-sm font-medium">
                      Akun Anda dikelola melalui Active Directory
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Password tidak dapat diubah melalui aplikasi ini. Untuk mengubah password,
                      gunakan portal IT perusahaan atau hubungi administrator Active Directory Anda.
                    </p>
                  </div>
                </CardContent>
              </Card>
            ) : (
              // Form for local accounts
              <Card>
                <CardHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 p-4 space-y-1">
                        ...
                        <p className="text-sm text-blue-700 dark:text-blue-400 pl-6">
                          Autentikasi dikelola melalui Active Directory. Akun pengguna dibuat secara
                          otomatis saat login pertama. Pengaturan LDAP dikonfigurasi melalui
                          variabel <code className="font-mono bg-blue-100 dark:bg-blue-900 px-1 rounded">LDAP_*</code> di file <code className="font-mono bg-blue-100 dark:bg-blue-900 px-1 rounded">.env</code>.
                        </p>
                      </div>
                    </div>

                    {/* Email / OTP section — kept for OTP login feature */}
                    <div className="space-y-4 border-t pt-4">
                      ...
                      <div className="flex items-center justify-between rounded-lg border p-4">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Tidak berlaku — pendaftaran manual dinonaktifkan karena menggunakan LDAP.
                          </p>
                        </div>
                        <Switch
                          checked={sysPrefs.email_verification_enabled}
                          disabled // disabled in LDAP mode
